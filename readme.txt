=== Popup - Popup Maker ===
Contributors: ActiveConvert
Tags: popup, exit popup, pop up,  popup maker, wordpress popup
...
== Description ==
Popup - Popup Maker by [ActiveConvert](http://www.activeconvert.com) helps build your email list, convert abandoning visitors, and send drip email sequences.  It works on desktop and mobile and integrates with Gmail, MailChimp, Constant Contact, Campaign Monitor, and other mail providers.

= Features =

* Popup Maker for email list building, coupons, feedback, and social networks
* Easy integration with any WordPress theme
* Quickly grow your email newsletter list
* Send drip email sequences right from Gmail and G Suite
* Asynchronous loading that won't affect page load speed
* Multiple unique template to choose from
* Simple email integration with MailChimp, Constant Contact, and Campaign Monitor
...
* MailChimp, Constant Contact, and Campaign Manager list integration
...
Once you add new subscribers, trigger unique email sequences to convert the subscribers into customers.  Add send rules, custom templates, photos, and more to each step in your sequence.
...
1. Upload folder popup-wp.zip to the `/wp-content/plugins/` directory
...
1. This is an example exit intent popup
2. These are screenshots of member pages
3. This is a screenshot of the online form designer
4. This is a screenshot of the contacts page
